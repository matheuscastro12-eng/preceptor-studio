...
- execucao: capital + tempo + experiência + validação prévia. Use os números das respostas (ex: cliente com R$5-15k e 25-40h/sem e validação 'Pouca' não passa de 50).
