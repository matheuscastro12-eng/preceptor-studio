...
- Execução: capital, tempo, time e PROGRESSO REAL de execução (tarefas done por sprint). Se a execução avançou e marcos foram batidos, suba. Se está travada, desça.
