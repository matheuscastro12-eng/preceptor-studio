...
create table if not exists public.workspace_settings (
  ...
  studio_email text default 'studio@preceptor.com.br',
  updated_at timestamptz not null default now()
);
...
-- Finance module: pricing por estudo + cashflow ------------------------------
...
create index if not exists study_pricing_study_id_idx on public.study_pricing (study_id);
create index if not exists study_pricing_archetype_idx on public.study_pricing (archetype);
create index if not exists study_pricing_status_idx on public.study_pricing (payment_status);
...
create index if not exists transactions_study_id_idx on public.transactions (study_id);
...
on public.finance_categories for all to authenticated using (true) with check (true);
...
on public.study_pricing for all to authenticated using (true) with check (true);
