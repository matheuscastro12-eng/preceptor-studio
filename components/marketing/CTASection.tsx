    ...
    <section className="section" data-screen-label="06 CTA">
      <div className="container">
        ...
        >
          ...
          >
            <div>
              <span className="eyebrow">Antes de gastar o seu dinheiro</span>
              <h2 className="mkt-h2" style={{ marginTop: 18, color: "#fff" }}>
                Descubra se a sua ideia <span className="cyan">dá dinheiro</span>,{" "}
              ...
              >
                11 perguntas rápidas, sem login. Você recebe na hora um retrato
                de onde o seu negócio ganha dinheiro e onde ele trava. A entrada
                é livre.
              </p>
              <div
                style={{
              ...
              >
                <Link
                  ...
                  aria-label="Descobrir se dá dinheiro"
                >
                  Descobrir se dá dinheiro
                  <span className="mkt-btn__icon" aria-hidden="true">→</span>
                </Link>
                <a
                  href="mailto:thiago@ospreceptores.com?subject=Conversa%20sobre%20o%20meu%20negócio"
            ...
            >
              {[
                ...
                "Onde o seu negócio ganha e onde ele perde dinheiro",
                "O próximo passo concreto pra faturar",
              ].map((t, i) => (
                <li
                  key={i}
